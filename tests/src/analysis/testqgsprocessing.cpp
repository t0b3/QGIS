...
void TestQgsProcessing::parameterMeshDatasetGroups()
{
  ...
  std::unique_ptr<QgsProcessingParameterMeshDatasetGroups> def( new QgsProcessingParameterMeshDatasetGroups( u"dataset groups"_s, u"groups"_s, QString(), supportedData ) );

...
void TestQgsMeshLayer::test_memory_dataset_group()
{
  ...
  std::unique_ptr<QgsMeshMemoryDatasetGroup> goodDatasetGroupFaces( new QgsMeshMemoryDatasetGroup( u"good faces datasets"_s, QgsMeshDatasetGroupMetadata::DataOnFaces ) );

...
class TestQgsMapToolLabel : public QObject
{
  ...
  private slots:
    ...
    void testSelectLabel()
    {
      ...
      std::unique_ptr<QMouseEvent> event( new QMouseEvent( QEvent::MouseButtonPress, QPoint( std::round( pt.x() ), std::round( pt.y() ) ), Qt::LeftButton, Qt::LeftButton, Qt::NoModifier ) );

...
void TestQgsMapToolAddPart::testAddPart()
{
  ...
  std::unique_ptr<QgsMapMouseEvent> event( new QgsMapMouseEvent( mCanvas, QEvent::MouseButtonRelease, mapToPoint( 5, 5 ), Qt::LeftButton ) );
...
void TestQgsMapToolAddPart::testAddPartClockWise()
{
  ...
  // Draw in clockwise
  std::unique_ptr<QgsMapMouseEvent> event( new QgsMapMouseEvent( mCanvas, QEvent::MouseButtonRelease, mapToPoint( 15, 15 ), Qt::LeftButton ) );
  mCaptureTool->cadCanvasReleaseEvent( event.get() );
...
void TestQgsMapToolAddPart::testAddPartToMultiLineString()
{
  ...
  std::unique_ptr<QgsMapMouseEvent> event( new QgsMapMouseEvent( mCanvas, QEvent::MouseButtonRelease, mapToPoint( 1, 3 ), Qt::LeftButton ) );
  mCaptureTool->cadCanvasReleaseEvent( event.get() );
